...
public partial class LightingPass
{
    ...
    struct OtherLightData
    {
        ...
        public static OtherLightData CreatePointLight(Light light, Vector4 shadowData, ref VisibleLight visibleLight)
        {
        ...
        public static OtherLightData CreateSpotLight(Light light, Vector4 shadowData, ref VisibleLight visibleLight)
        {
